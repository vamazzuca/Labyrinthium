...
const MenuOverlay = ({ links }) => {
  ...
  return (
      ...
      <div className='w-full bg-[#3500D3] flex flex-wrap items-center justify-between p-4 sm:px-8'>
      ...
      <ul className='flex flex-col gap-4 py-4 text-2xl items-center bg-[#3500D3] w-full h-screen'>{links.map((link, index) => (
          <li key={index}>
